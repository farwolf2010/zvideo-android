...
public class QSVideoView extends FrameLayout implements IVideoPlayer, IMediaCallback {
    ...
    public boolean full_flag;//标记状态栏状态
    public boolean orientation_flag;//标记横竖屏状态
    ...
    //设置播放状态
    public void setStateAndMode(final int status, final int mode) {
